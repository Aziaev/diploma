	...
	<div class="container">
		<div class="jumbodiv">
			...
			<c:if test="${empty name}">
				<h1>Welcome to use Happy Messenger!</h1>
			</c:if>
			<p>This is simple nor cloud nor blockchain nor bigdata nor
				high-availability diploma project technologies</p>
				...
				<div class="modal-dialog" role="document">
					<div class="modal-content">
						<div class="modal-header">
							...
							<h4 class="modal-title" id="myModalLabel">Used technologies
								and stuff</h4>
						</div>
